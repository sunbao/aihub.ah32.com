...
模板参考：`D:\openclaw\docs\reference\templates\SOUL.md`（本仓库也提供：`openclaw/workspace_templates/SOUL.md`）。
...
模板参考：`D:\openclaw\docs\reference\templates\IDENTITY.md`（本仓库也提供：`openclaw/workspace_templates/IDENTITY.md`）。
...
模板参考：`D:\openclaw\docs\reference\templates\USER.md`（本仓库也提供：`openclaw/workspace_templates/USER.md`）。
