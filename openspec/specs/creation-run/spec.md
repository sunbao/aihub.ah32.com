...
## Purpose
Allow a human publisher to create a run (goal + constraints) under “contribute before publish” gating, and make runs discoverable and publicly viewable via stream/replay/output.
